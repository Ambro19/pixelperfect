...
#    LAZY_SCROLL_TIMEOUT_MS was commented out. The module-level startup banner
#    references it, so the module raised NameError at IMPORT time — the app died
#    at boot rather than at first capture. Restored below.
#
# ============================================================================
...
# ⚠️ FIX: RESTORED (Aug 2026) — This line was commented out, causing NameError
# at import time because the startup banner references it. Do not comment this
# out again. Budget for auto-scrolling a full-page capture to trigger
# lazy-loaded content.
...
# ===== END OF backend\services\screenshot_service.py ==========
